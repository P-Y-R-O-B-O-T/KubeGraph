...
class VALIDATING_ADMISSION_POLICY_RUNNER(AdmissionregistrationV1beta1Api_RUNNER):
    def __init__(self) -> None:
        super().__init__(
            "AdmissionregistrationV1beta1Api_VALIDATING_ADMISSION_POLICIES"
        )
...
class VALIDATING_ADMISSION_POLICY_BINDING_RUNNER(
    AdmissionregistrationV1beta1Api_RUNNER
):
    def __init__(self) -> None:
        super().__init__(
            "AdmissionregistrationV1beta1Api_VALIDATING_ADMISSION_POLICY_BINDINGS"
        )
