...
NODE_DATA_REDIS_CRED_USER="${NODE_DATA_REDIS_CRED_USER:-default}"
NODE_DATA_REDIS_CRED_PASSWD="${NODE_DATA_REDIS_CRED_PASSWD:-default}"
...
user $CLUSTER_WATCH_REDIS_CRED_USER on >$CLUSTER_WATCH_REDIS_CRED_PASSWD +@read +@write +del %RW~CLUSTER_DATA:*  %RW~RESOURCE_VERSION_BOOKMARKS:*
user $CLUSTER_STATE_REDIS_CRED_USER on >$CLUSTER_STATE_REDIS_CRED_PASSWD +@read +@write +del %RW~CLUSTER_DATA:*  %RW~RESOURCE_VERSION_BOOKMARKS:*

user $NODE_DATA_REDIS_CRED_USER on >$NODE_DATA_REDIS_CRED_PASSWD +@read +@write +del %R~CLUSTER_DATA:* %RW~CLUSTER_DATA:UPDATES_QUEUE %RW~GRAPHS:*

user $API_REDIS_CRED_USER on >$API_REDIS_CRED_PASSWD +@read +@write %RW~RESOURCE_VERSION_BOOKMARKS:* %RW~CLUSTER_DATA:* %R~GRAPHS:*

user $GRAPHGEN_REDIS_CRED_USER on >$GRAPHGEN_REDIS_CRED_PASSWD +@read +@write %R~CLUSTER_DATA:* %RW~GRAPHS:*
